...
if (not IM_NAME and not IM_DIR):
    os.system("fswebcam --no-banner /home/pi/tflite1/test1.jpg")
    IM_NAME = 'test1.jpg'
...
for image_path in images:
    ...
    # count persons
    cv2.putText(image,'Personen: {0:.2f}'.format(personCount),(30,50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,0),2,cv2.LINE_AA)
    
    # save personcount to file
    with open('125', 'w') as f:
        f.write(str(personCount))
    
    #upload personcount to Webserver
    os.system("scp 125 guoweicsuf@35.193.77.108:/var/www/html")
